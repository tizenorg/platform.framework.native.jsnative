...
#ifndef TIZEN_APPLICATION_APPFW_H_
#define TIZEN_APPLICATION_APPFW_H_
...
class AppFW {
 ...
 private:
  ...
  std::function<void(const std::string&)> service_handler_;
...
#endif  // TIZEN_APPLICATION_APPFW_H_
