...
void DeviceInstance::Initialize() {
  ...
  // Led
  REGISTER_XWALK_METHOD("led.getMaxBrightness",
      this, &DeviceInstance::HandleLedGetMaxBrightness);
  REGISTER_XWALK_METHOD("led.getBrightness",
      this, &DeviceInstance::HandleLedGetBrightness);
  REGISTER_XWALK_METHOD("led.setBrightness",
      this, &DeviceInstance::HandleLedSetBrightness);
...
void DeviceInstance::HandleLedGetMaxBrightness(
    const Json::Value& args, Json::Value& reply) {

}

void DeviceInstance::HandleLedGetBrightness(
    const Json::Value& args, Json::Value& reply) {

}

void DeviceInstance::HandleLedSetBrightness(
    const Json::Value& args, Json::Value& reply) {
