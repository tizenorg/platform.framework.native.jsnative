...
class DeviceInstance : public xwalk::XWalkExtensionInstance {
 ...
 private:
  ...
  // Handlers for Led
  void HandleLedGetMaxBrightness(const Json::Value& args, Json::Value& reply);
  void HandleLedGetBrightness(const Json::Value& args, Json::Value& reply);
  void HandleLedSetBrightness(const Json::Value& args, Json::Value& reply);
