...
void MessagePortInstance::HandleMessage(const char* msg) {
  ...
  if (cmd == "send") {
    ...
    LOGD("exist: %s, trusted: %s", (exist == true) ? "true" : "false",
...
void MessagePortInstance::FireSimpleEvent(const std::string& event,
  ...
  LOGD("%s | event: %s, data: %s", __func__, event.c_str(), data.c_str());
...
void MessagePortInstance::RegisterLocalPort(const std::string& localPort,
                                            bool trusted) {
  LOGD("%s | localPort: %s, trusted: %s",
       __func__, localPort.c_str(), (trusted == true) ? "true" : "false");
  ...
  auto receiveCb = [](int localPortId, const char* remoteAppId,
    ...
    LOGD("receiveCb | id: %d, appId: %s, port: %s",
         localPortId, remoteAppId, remotePort);
...
void MessagePortInstance::SendMessage(const std::string& asyncId,
  ...
  LOGD("%s | asyncid: %s, appId: %s, port: %s, trusted: %s",
       __func__, asyncId.c_str(), remoteAppId.c_str(), remotePort.c_str(),
       (trusted == true) ? "true" : "false");
...
void MessagePortInstance::SendMessageWithLocalPort(const std::string& asyncId,
  ...
  LOGD("%s | asyncid: %s, appId: %s, port: %s, id: %d, trusted: %s",
       __func__, asyncId.c_str(), remoteAppId.c_str(), remotePort.c_str(),
       localId, (trusted == true) ? "true" : "false");
