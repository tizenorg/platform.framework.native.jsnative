...
class MessagePortInstance : public xwalk::XWalkExtensionInstance {
 ...
 private:
  ...
  void IsRegisteredRemotePort(const std::string& asyncId,
                              const std::string& remoteAppId,
                              const std::string& remotePort, bool trusted);
  void SendMessage(const std::string& async_id, const std::string& remoteAppId,
                   const std::string& remotePort, bundle* message,
                   bool trusted);
  void SendMessageWithLocalPort(const std::string& async_id,
                                const std::string& remoteAppId,
                                const std::string& remotePort, bundle* message,
                                int localId, bool trusted);
};
