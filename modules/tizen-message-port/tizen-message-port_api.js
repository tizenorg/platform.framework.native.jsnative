...
class MessagePort {
   ...
   * @param [options.trusted] {Boolean} trusted Is this port to listen trusted
   * * port? This is skipped and its default value is false.
   * @param [options.callback] {Function} callback Callback function to be
   ...
   * @param [options receiver.trusted] {Boolean} receiver.trusted Value whether
   ...
   * ```
   * @param [options.sender] {Object} sender Sender to send this message.
   ...
   * @parma [options.sender.trusted] {Boolean} sender.trusted Value whether the
