...
class PackageInfo {
  ...
  get isSystemPackage() {
    ...
    return getPackageInfo().isSystemPackage;
  }
  ...
  get installedStorage() {
    ...
    return getPackageInfo().installedStorage;
  }
  ...
  get rootPath() {
    ...
    return getPackageInfo().rootPath;
  }
  ...
  get isRemovablePackage() {
    ...
    return getPackageInfo().isRemovablePackage;
  }
  ...
  get isPreloadPackage() {
    ...
    return getPackageInfo().isPreloadPackage;
  }
  ...
  get isAccessible() {
    ...
    return getPackageInfo().isAccessible;
  }
