 ...
 * @attribute MATCH Matching certification
 * @attribute MISMATCH Mismatching certification
 * @attribute LHS-NO-CERT First package has no certification
 * @attribute RHS-NO-CERT Second package has no certification
 * @attribute BOTH-NO-CERT Both have no certification
 **/
var CompareResultType = {
  'MATCH': 'match',
  'MISMATCH': 'mismatch',
  'LHS-NO-CERT': 'lhs-no-cert',
  'RHS-NO-CERT': 'rhs-no-cert',
  'BOTH-NO-CERT': 'both-no-cert'
};
