...
static bool package_info_app_cb(package_info_app_component_type_e comp_type, const char *appId, void *user_data) {
...
static bool package_info_privilege_info_cb(const char *privilegeName, void *user_data) {
...
static bool package_manager_package_info_cb(const package_info_h info, void* user_data) {
...
static void package_manager_size_info_receive_cb(const char* packageId, const package_size_info_h sizeInfo, void* user_data) {
