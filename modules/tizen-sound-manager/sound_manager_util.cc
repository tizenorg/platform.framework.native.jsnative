...
const std::map<std::string, sound_device_mask_e>
  SoundManagerUtil::sound_device_mask_map_ = {
...
const char*
SoundManagerUtil::SoundSessionTypeToString(sound_session_type_e type) {
...
std::string
SoundManagerUtil::SoundDeviceTypeToString(sound_device_type_e type) {
  switch (type) {
...
std::string
SoundManagerUtil::SoundIOTypeToString(sound_device_io_direction_e direction) {
  switch (direction) {
...
std::string
SoundManagerUtil::SoundStateToString(sound_device_state_e  state) {
  switch (state) {
...
sound_device_mask_e
SoundManagerUtil::FilterStringToEnum(const std::string& key) {
...
const char*
SoundManagerUtil::SoundSessionStartOptionToString(
    sound_session_option_for_starting_e option) {
...
const char*
SoundManagerUtil::SoundSessionInterruptOptionToString(
    sound_session_option_for_during_play_e option) {
...
const char*
SoundManagerUtil::SoundSessionResumptionOptionToString(
...
const char*
SoundManagerUtil::SoundSessionVoipModeToString(sound_session_voip_mode_e mode) {
...
const char*
SoundManagerUtil::SoundSessioninterruptedCodeToString(
    sound_session_interrupted_code_e type) {
...
SoundManagerUtil::SoundSessionStartOptionToInt(const char* option) {
...
SoundManagerUtil::SoundSessionInterruptOptionToInt(const char* option) {
...
SoundManagerUtil::SoundSessionResumptionOptionToInt(const char* option) {
...
SoundManagerUtil::SoundSessionVoipModeToInt(const char* mode) {
