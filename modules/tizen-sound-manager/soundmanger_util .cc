...
const char* SoundMangerUtil::soundSessionTypeToString(sound_session_type_e type) {
  LOGD("enter");
...
const char* SoundMangerUtil::soundSessionStartOptionToString(sound_session_option_for_starting_e option) {
  LOGD("enter");
...
const char* SoundMangerUtil::soundSessionPlayingOptionToString(sound_session_option_for_during_play_e option) {
  LOGD("enter");
...
const char* SoundMangerUtil::soundSessionResumptionOptionToString(sound_session_option_for_resumption_e option) {
  LOGD("enter");
  ...
  if (option == SOUND_SESSION_OPTION_RESUMPTION_BY_SYSTEM) {
    ...
    return "BY_SYSTEM_OR_MEDIA_PAUSED";
  } else {
