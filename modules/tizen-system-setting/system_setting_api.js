...
* The 'tizen-system-setting' module exports
* an instance of SystemSetting class.<br>
...
/**
 * SystemSetting Class provides functions for getting
 * the system configuration related to user preferences.<br>
 * The main features of the System Settings API include
 * accessing system-wide configurations, such as ringtones and wallpapers.
 * The instance of this class will be returned
 * when the require('tizen-system-setting') is called.
### System Setting Keys
...
| lockscreen-app | Any string for the app package name |
| default-font-type | Any string for the system default font type |
| locale-country | Any string in the <LANGUAGE>_<REGION> syntax. |
| locale-language | Any string in the <LANGUAGE>_<REGION> syntax |
...
class SystemSetting extends EE {
   ...
   * @value 'sound-notification-repetition-period'
   * @value 'lock-state'
   * @param {String|Number|Boolean} value The new system settings value of
   * the given key. About available values for each keys,
   * Please see System Setting Keys table.
   * @throws
   ...
   * About available values for each keys,
   * Please see System Setting Keys table.
   */
  getValue(key) {
    var keyType = settingKeyTypes[key];
